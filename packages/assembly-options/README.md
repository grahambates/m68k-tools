...
Private, shared options for how a project's source is assembled, read once so the tools agree: the processors it targets, the directories the assembler searches for includes, and whether symbol names keep their case.
