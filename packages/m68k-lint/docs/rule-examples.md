...
- Made for 10 and not written from an expression, if the dividend is also never negative and below 4096: mulu.w #6554,d0 ; swap d0 (60 cycles).
- Made for 10 and not written from an expression, if the dividend is also never negative and below 256: mulu.w #6560,d0 ; swap d0 (56 cycles).
