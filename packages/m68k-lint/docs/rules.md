...
161 built-in rules. `m68k-lint --list-rules` prints the same set.
...
| [`optimization/combine-address-adjustments`](rule-examples.md#optimizationcombine-address-adjustments) | suggestion | yes | Combine consecutive constant adjustments of the same address register | Exhaustive search over 68000 instruction pairs, checked against Musashi |
...
| [`optimization/divs-word-by-constant`](rule-examples.md#optimizationdivs-word-by-constant) | suggestion | yes | Replace signed word division by a constant with a multiply by its reciprocal when only the quotient of a small dividend is needed | Generated by scripts/generate-divide-recipes.mjs (signed reciprocal multiplication with a correction for negative dividends) |
| [`optimization/divs-word-power-of-two`](rule-examples.md#optimizationdivs-word-power-of-two) | suggestion | yes | Replace signed word division by a power of two with an arithmetic shift when only the quotient is needed and rounding toward minus infinity is acceptable | Generated by scripts/generate-divide-recipes.mjs (the exact forms listed in the notes) |
...
| [`optimization/divu-word-by-constant`](rule-examples.md#optimizationdivu-word-by-constant) | suggestion | yes | Replace unsigned word division by a constant with a multiply by its reciprocal when only the quotient of a small dividend is needed | Generated by scripts/generate-divide-recipes.mjs (reciprocal multiplication, and shift/add sequences for small dividends) |
